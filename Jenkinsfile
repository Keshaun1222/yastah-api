node {
    ...
    stage("publish") {
        ...
        s3Upload acl: 'Private', bucket: 'keshaun-artifact-storage', cacheControl: '', excludePathPattern: '', file: 'target/*.jar', metadatas: [''], redirectLocation: '', sseAlgorithm: '', tags: '', workingDir: ''
    }
}