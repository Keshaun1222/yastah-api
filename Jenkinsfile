node {
    ...
    stage("publish") {
        ...
        withAWS(credentials: '4bf5362a-be26-4de8-a179-d58b338ed61d', region: 'us-east-2') {
            s3Upload acl: 'Private', bucket: 'keshaun-artifact-storage', cacheControl: '', excludePathPattern: '', file: 'app.jar', metadatas: [''], redirectLocation: '', sseAlgorithm: '', tags: '', workingDir: ''
        }
    }
}